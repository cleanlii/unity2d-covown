...
public class MainMenuEditor : Editor
{
    ...
    private SerializedProperty goContinue;
    private SerializedProperty gallery;
    ...
    private SerializedProperty continueText;
    private SerializedProperty galleryText;
    ...
    private SerializedProperty buttonsObj;
    private SerializedProperty leftArrow;
    private SerializedProperty rightArrow;
    ...
    private void OnEnable()
    {
        ...
        goContinue = soTarget.FindProperty("goContinue");
        gallery = soTarget.FindProperty("gallery");
        ...
        buttonsObj = soTarget.FindProperty("buttonsObj");
        leftArrow = soTarget.FindProperty("leftArrow");
        rightArrow = soTarget.FindProperty("rightArrow");
        ...
        continueText = soTarget.FindProperty("continueText");
        galleryText = soTarget.FindProperty("galleryText");
    ...
    private void Values()
    {
        ...
        EditorGUILayout.PropertyField(goContinue);
        EditorGUILayout.PropertyField(gallery);
        ...
        EditorGUILayout.PropertyField(buttonsObj);
        EditorGUILayout.PropertyField(leftArrow);
        EditorGUILayout.PropertyField(rightArrow);
    ...
    private void Components()
    {
        ...
        EditorGUILayout.PropertyField(galleryText);
